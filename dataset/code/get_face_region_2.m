...
function face = get_face_region_2(image, eyes_position, out_size)
...
w_face = round(eyes_distance * 128.0 / 56);
h_face = round(w_face * double(h_out) / w_out);
% h_face = (2.4 * eyes_distance);
dis_eye_top = 42.0 / 128 * h_face;
dis_eye_left = 36.0 / 128 * w_face;
