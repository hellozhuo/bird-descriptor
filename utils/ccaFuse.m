function [Ax,Ay,Xs,Ys] = dcaFuse(Xp,Yp,label)
...
Sxy = Xp * Yp';	% Between-set covariance matrix, p x p 
...
Ax = Wcx';	% Final transformation Matrix of size (rxp) for X
Ay = Wcy';	% Final transformation Matrix of size (rxq) for Y
